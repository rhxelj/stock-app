...
router.post("/", function (req, res, next) {
    ...
    datospresup.map(reng => {
        ...
        var ImpItem = { text: formatter.format(importeItem).toString(), style: 'tableDatosD' }
    ...
    var PdfPrinter = require('/home/sandra/SistOLSA/OlsaSG/backend/node_modules/pdfmake/src/printer');
    ...
    pdfDoc.pipe(fs.createWriteStream('/home/sandra/SistOLSA/OlsaSG/backend/routes/impresion/basics.pdf'));
    pdfDoc.end();
});
conexion.end;
