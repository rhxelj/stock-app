...
export default function FilaDos(props) {
  ...
  async function agregar() {
    ...
    const datosrenglon1 = await presupcalculador(datoscalculos, state.PresupTipo);
  ...
  return (
    <>
      <Grid container item direction="column" spacing={3} xs={6} sm={3}>
        <Grid item xs>
          <TextField
      ...
      <FilaTres open={open} handleClose={handleClose} data={datosrenglon} maymin={state.PresupMnMy} />
      {/* <FilaTres></FilaTres> */}
    </>
  );
}
