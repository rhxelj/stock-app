...
export default function Fila() {
  ...
  const confirmar = async state => {
    ...
    //llamo al cartel
    // Confirmacion();
    // borro el contenido de mis campos
    console.log("llamo a handleclickopen")
    handleClickOpen()
  ...
  return (
    <>
      <Grid container item spacing={2} justify="flex-end">
        ...
        <Confirmacion open={open} title="Movimiento de Entrada" contentText="Cambio efectuado" handleClose={handleClose} />
      </Grid>
    </>
  );
}
