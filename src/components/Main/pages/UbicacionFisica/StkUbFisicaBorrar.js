...
class BorrarUnidadMedidas extends Component {
    ...
    ubfisicaborrar = (idStkUbFisica,StkUbFisicaGeo)=> {
        ...
        request
            .get(url + '?idStkUbFisica='+idStkUbFisica+'&StkUbFisicaGeo='+StkUbFisicaGeo)
            ...
            <div>
                ...
                :
                    ...
                    <div className="center-align">
                        <p>Borrar ?</p>
                        <IconButton color="primary" onClick={()=>this.ubfisicaborrar(this.props.idStkUbFisica, this.props.StkUbFisicaGeo)}><DoneIcon/></IconButton>
