...
toggleState = prop => event =>{
  this.setState({[prop]: event.target.value},()=> alert(`Cambio el estado de ${[prop]}`))
}
      ...
      <div>
        ...
        {/* Cantidad/ StkRubroPresDes / StkRubroPres / StkRubroUM */}
            ...
            <DialogActions> */}
                  ...
                  >
                    ...
                    <Button variant="contained" color="secondary" onClick={this.limpioPantalla}>
                        Cancelar
                    </Button>
                  </Grid>
          </Fragment>
        ...
        >
          ...
          <DialogActions>
            ...
            <Button variant="contained" color="primary" onClick = {this.toggleImprimir}  >
              Imprimir
            </Button>
        ...
        {this.state.toggle_state.imprimir && <StkGenImpQR ubicaG = {this.state.StkEnvaseUbG} cancelaImpresion={this.cancelaImpresion}/>}
